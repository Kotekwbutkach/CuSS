...
string_vars = [tk.StringVar() for x in range(2) for y in range(4)]

title_frame = tk.Frame(normal_params_frame, width=310, height=50, borderwidth=2, relief="raised", padx=2)
x_top_frame = tk.Frame(normal_params_frame, width=100, height=30, borderwidth=2, relief="raised", padx=2)
x_bottom_frame = tk.Frame(normal_params_frame, width=100, height=130, borderwidth=2, relief="raised", padx=2)
y_top_frame = tk.Frame(normal_params_frame, width=100, height=30, borderwidth=2, relief="raised", padx=2)
y_bottom_frame = tk.Frame(normal_params_frame, width=100, height=130, borderwidth=2, relief="raised", padx=2)
...
mean_x1_entry = tk.Entry(normal_params_frame, textvariable=string_vars[0], width=5)
mean_x2_entry = tk.Entry(normal_params_frame, textvariable=string_vars[1], width=5)
mean_v1_entry = tk.Entry(normal_params_frame, textvariable=string_vars[2], width=5)
mean_v2_entry = tk.Entry(normal_params_frame, textvariable=string_vars[3], width=5)
std_dev_x1_entry = tk.Entry(normal_params_frame, textvariable=string_vars[4], width=5)
std_dev_x2_entry = tk.Entry(normal_params_frame, textvariable=string_vars[5], width=5)
std_dev_v1_entry = tk.Entry(normal_params_frame, textvariable=string_vars[6], width=5)
std_dev_v2_entry = tk.Entry(normal_params_frame, textvariable=string_vars[7], width=5)
...
normal_distribution_params = np.array([[1, 2, 3, 4], [5, 6, 7, 8]])
